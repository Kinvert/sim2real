...
ELF="$LINE_FOLLOW_ROOT/build/parallax-smoke/drive_ticks_probe.elf"
...
echo "WARNING: this commands motors briefly, then stops. It does not write EEPROM."
echo "Press Ctrl-C to leave terminal mode after the probe prints done."
