...
LINE_FOLLOW_H4L1_SELECTED_RUN_ID="${LINE_FOLLOW_H4L1_SELECTED_RUN_ID:-it957b0t}"
LINE_FOLLOW_H4L1_SELECTED_CHECKPOINT="${LINE_FOLLOW_H4L1_SELECTED_CHECKPOINT:-$SIM2REAL_ROOT/checkpoints/line_follow/it957b0t/0000000139984896.bin}"
